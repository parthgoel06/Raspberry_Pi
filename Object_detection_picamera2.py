...
image_tensor = numpad.detection_graph.get_tensor_by_name('image_tensor:0')

# Output tensors are the detection boxes, scores, and classes
# Each box represents a part of the image where a particular object was detected
detection_boxes = numpad.detection_graph.get_tensor_by_name('detection_boxes:0')

# Each score represents level of confidence for each of the objects.
# The score is shown on the result image, together with the class label.
detection_scores = numpad.detection_graph.get_tensor_by_name('detection_scores:0')
detection_classes = numpad.detection_graph.get_tensor_by_name('detection_classes:0')

# Number of objects detected
num_detections = numpad.detection_graph.get_tensor_by_name('num_detections:0')
...
if camera_type == 'picamera':
    ...
    (boxes, scores, classes, num) = numpad.sess.run(
